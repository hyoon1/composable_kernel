    ...
    : public UniversalGemmBasePolicy<UniversalGemmPipelineAgBgCrPolicy>
{
    ...
    CK_TILE_HOST static void DebugPrintWgAttr()
    {
        ...
        using WarpGemmSel = WarpGemmDispatcher<typename Problem::ComputeDataType,
                                            typename Problem::ComputeDataType,
                                            typename Problem::CDataType,
                                            Problem::BlockGemmShape::WarpTile::at(Base::I0),
                                            Problem::BlockGemmShape::WarpTile::at(Base::I1),
                                            Problem::BlockGemmShape::WarpTile::at(Base::I2),
                                            Problem::TransposeC,
                                            false,
        ...
        if constexpr(std::is_same_v<WarpGemmSel, WarpGemmWmma_f32_16x16x32_f16_f16<Problem::TransposeC>>)
        {
            std::printf("[DEBUG] WarpGemmDispatcher matched WMMA 16x16x32 f16\n");
        }
        else if constexpr(std::is_same_v<WarpGemmSel, WarpGemmWmma_f32_16x16x16_f16_f16<Problem::TransposeC>>)
        {
            std::printf("[DEBUG] WarpGemmDispatcher matched WMMA 16x16x16 f16\n");
        }
